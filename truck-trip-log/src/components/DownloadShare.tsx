  ...
  const createResultElement = () => {
   ...
   <div class="log-container">
    <div class="log-header">
        <p><strong>Driver:</strong> <span id="driverName">${
          logs && logs.driverName
        }</span></p>
        <p><strong>Truck Number:</strong> <span id="truckNumber">${
          logs && logs.truckNumber
        }</span></p>
        <p><strong>Carried Product:</strong> <span id="carriedProduct">${
          logs && logs.carriedProduct
        }</span></p>
        <p><strong>Total Miles:</strong> <span id="totalMiles">${
          logs && logs.totalMiles
        }</span></p>
    </div>
    <h3 class="log-date">Date: <span id="logDate">${
      logs && logs.date
    }</span></h3>
        ...
        <table class="log-table">
            ...
            <tbody>
                ...
                <tr class="log-row">
                    ...
                    <td class="log-cell">${
                      logs && logs.offDutyHours["0:00-11:59"]
                    }</td>
                    <td class="log-cell">${
                      logs && logs.offDutyHours["12:00-17:59"]
                    }</td>
                    <td class="log-cell">${
                      logs && logs.offDutyHours["18:00-23:59"]
                    }</td>
                    <td class="log-cell">
                        ${
                          logs &&
                ...
                <tr class="log-row">
                    ...
                    <td class="log-cell">${
                      logs && logs.drivingHours["0:00-11:59"]
                    }</td>
                    <td class="log-cell">${
                      logs && logs.drivingHours["12:00-17:59"]
                    }</td>
                    <td class="log-cell">${
                      logs && logs.drivingHours["18:00-23:59"]
                    }</td>
                    <td class="log-cell">
                        ${
                          logs &&
                ...
                <tr class="log-row">
                    ...
                    <td class="log-cell">${
                      logs && logs.sleeperBerthHours["0:00-11:59"]
                    }</td>
                    <td class="log-cell">${
                      logs && logs.sleeperBerthHours["12:00-17:59"]
                    }</td>
                    <td class="log-cell">${
                      logs && logs.sleeperBerthHours["18:00-23:59"]
                    }</td>
                    <td class="log-cell">
                        ${
                          logs &&
                ...
                <tr class="log-row">
                    ...
                    <td class="log-cell">${
                      logs && logs.onDutyHours["0:00-11:59"]
                    }</td>
                    <td class="log-cell">${
                      logs && logs.onDutyHours["12:00-17:59"]
                    }</td>
                    <td class="log-cell">${
                      logs && logs.onDutyHours["18:00-23:59"]
                    }</td>
                    <td class="log-cell">
                        ${
                          logs &&
    ...
    <p class="status-message">${
      logs && logs.isBelowAverage ? statusMessage : ""
    }</p>
      ...
      await navigator.share({
        ...
        files: [
          new File(
            ...
            `${logs && logs.driverName}_result.png`,
            { type: "image/png" }
          ),
        ],
      });
  ...
  return (
    <div className="flex gap-2 items-center justify-center mt-4 text-sm">
      ...
      >
        ...
        <span className="text-[11px] max-sm:hidden">Download</span>
      </button>
      <button
      ...
      >
        ...
        <span className="text-[11px] max-sm:hidden">Share</span>
      </button>
    </div>
  );
};
