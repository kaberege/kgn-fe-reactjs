...
const History = () => {
  ...
  const fetchTripLogs = async () => {
    ...
    try {
      ...
      const response = await axios.get<TripLogsResponse>(
  ...
  return (
    <div className="container mx-auto">
      {loading ? (
        <div className="text-center mt-10 text-red-600 font-semibold py-2">
          Loading...
        </div>
      ) : error ? (
          ...
          <div>
            ...
            {tripLogs.map((log, index) => (
              <div key={index} className="mb-8">
                <h2 className="text-lg sm:text-xl font-semibold mt-4 dark:text-slate-100">
                  ...
                  <table className="table-auto w-full text-sm mt-4 border-collapse">
                    ...
                    <tbody className="bg-gray-100 dark:bg-gray-800 dark:text-slate-100">
                      <tr className="hover:bg-gray-200 dark:hover:bg-gray-700">
                        ...
                        <td className="p-2 border whitespace-nowrap">
                          {log.pickup_location_name}
                        </td>
                        <td className="p-2 border whitespace-nowrap">
                          {log.dropoff_location_name}
                        </td>
                        <td className="p-2 border whitespace-nowrap">
                          {log.carried_product_name}
                        </td>
                        <td className="p-2 border whitespace-nowrap">
                          {log.duty_status}
                        </td>
                ...
                <div>
                  <h2 className="text-lg sm:text-xl font-semibold my-4 dark:text-slate-100">
                        ...
                        <tbody className="bg-gray-100 dark:bg-gray-800 dark:text-slate-100">
                          ...
                          <tr>
                            ...
                            <td className="p-2 border">
                              {log.off_duty_hours_0_11}
                            </td>
                            <td className="p-2 border">
                              {log.off_duty_hours_12_17}
                            </td>
                            <td className="p-2 border">
                              {log.off_duty_hours_18_23}
                            </td>
                            <td className="p-2 border">
                              {log.off_duty_hours_0_11 +
                                log.off_duty_hours_12_17 +
                          ...
                          <tr>
                            ...
                            <td className="p-2 border">
                              {log.driving_hours_0_11}
                            </td>
                            <td className="p-2 border">
                              {log.driving_hours_12_17}
                            </td>
                            <td className="p-2 border">
                              {log.driving_hours_18_23}
                            </td>
                            <td className="p-2 border">
                              {log.driving_hours_0_11 +
                                log.driving_hours_12_17 +
                          ...
                          <tr>
                            ...
                            <td className="p-2 border">
                              {log.sleeper_berth_hours_0_11}
                            </td>
                            <td className="p-2 border">
                              {log.sleeper_berth_hours_12_17}
                            </td>
                            <td className="p-2 border">
                              {log.sleeper_berth_hours_18_23}
                            </td>
                            <td className="p-2 border">
                              {log.sleeper_berth_hours_0_11 +
                                log.sleeper_berth_hours_12_17 +
                          ...
                          <tr>
                            ...
                            <td className="p-2 border">
                              {log.on_duty_hours_0_11}
                            </td>
                            <td className="p-2 border">
                              {log.on_duty_hours_12_17}
                            </td>
                            <td className="p-2 border">
                              {log.on_duty_hours_18_23}
                            </td>
                            <td className="p-2 border">
                              {log.on_duty_hours_0_11 +
                                log.on_duty_hours_12_17 +
