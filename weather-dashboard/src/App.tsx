...
function App() {
  ...
  return (
    <div
      className={`${
        mode && "dark"
      } flex flex-col bg-gray-100 min-h-screen transition-colors duration-300`}
    >
      ...
      <main className="p-4 flex flex-col justify-center items-center flex-grow relative">
        <h1 className="text-xl font-bold sm:hidden absolute top-2">
          Weather Dashboard
        </h1>
        <Outlet />
      </main>
      <footer className="bg-gray-800 dark:bg-gray-900 text-white text-center p-2">
        <p className="text-xs font-semibold max-w-[95%] mx-auto">
          Copyright &copy;{date}{" "}
          <a
