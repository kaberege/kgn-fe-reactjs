...
export default function Die(props) {
    ...
    if (props.value === 2) {
        spaned = <div className="die-two-container">
            <div className="die-two-content"></div>
            <div className="die-two-content"></div>
        </div>
    }
    if (props.value === 3) {
        spaned = <div className="die-three-container">
    ...
    if (props.value === 4) {
        spaned = <div className="die-four-container">
    ...
    if (props.value === 5) {
        spaned = <div className="die-five-container">
    ...
    if (props.value === 6) {
        spaned = <div className="die-six-container">
