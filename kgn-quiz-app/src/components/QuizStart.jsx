    ...
    <div className="text-center">
      ...
      {loading && (
        <p className="dark:text-slate-300">
          Loading categories<span className="animate-ping">...</span>
        </p>
      )}
      <div>
        ...
        {loadError && (
          <button
            ...
            className="flex items-center cursor-pointer mx-auto underline mt-3 text-blue-500 transition hover:text-blue-300"
          >
        ...
        <div>
          <form onSubmit={handleSubmit} className="mt-4">
            <div>
              <label
                htmlFor="category"
                className="block mb-1 dark:text-slate-300"
              >
              ...
              <select
                ...
                className={`border-2 max-sm:max-w-48 rounded p-1 ${
                  error.category ? "border-red-600" : "border-stone-500"
                }`}
              >
                <option value="choose" className="text-center">
                  Choose category...
                </option>
            ...
            <div className="mt-4">
              ...
              <select
                ...
                className={`border-2  rounded p-1 ${
                  error.difficulty ? "border-red-600" : "border-stone-500"
                }`}
              >
              ...
              {error.difficulty && (
                <p className="text-red-600">{error.difficulty}</p>
              )}
            </div>
            <div className="mt-4">
              <label
              ...
              <input
                ...
                min={1}
                className={`border-2  max-sm:max-w-48 rounded p-1 ${
                  error.number ? "border-red-600" : "border-stone-500"
                }`}
              />
