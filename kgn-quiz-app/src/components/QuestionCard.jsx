...
export default function QuestionCard() {
  ...
  const myHistory = () => {
    ...
    const localArr = JSON.parse(localStorage.getItem("historyquiz")) || [];
    localArr.push(topicResults);
    localStorage.setItem("historyquiz", JSON.stringify(localArr)); // Storing quiz results to the local storage
