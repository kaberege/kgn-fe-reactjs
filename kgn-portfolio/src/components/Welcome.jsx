        ...
        <>
            <section className={`min-h-screen w-full flex flex-col ${!mode ? "bg-light-gradient" : "bg-dark-gradient"} transition-colors duration-300`}>
                ...
                <div className="flex items-center justify-center flex-grow">
                    <div className='w-full max-sm:h-52 max-sm:max-w-96 sm:max-w-xl sm:h-80 relative'>
                        <img
                            src={devLaptop}
                            alt="Dev machine"
                        ...
                        />
                        <div
                            className='absolute max-sm:top-4 max-sm:left-1/3 sm:top-5 sm:left-1/3 flex items-center justify-center max-sm:w-20 max-sm:h-20 w-40 h-40 '
                        >
                            <img
                                src={profile}
                                alt="kgn profile"
